...
//echo '<pre>';var_dump($opt['params']);exit(1);		
...
/*						
echo '<pre>';
var_dump(	$this->param['http']  );
var_dump( 		$opt['params']);
var_dump( 	$this->param	);  exit();*/		
						
						$result = call_user_func($opt['handler'], $opt['params'], $this->param['url'], $opt['isTest']); //, $_db, $_session, $_uid, $_cache, $_browser); $this->param['http']
						$_cacheResult = false;
