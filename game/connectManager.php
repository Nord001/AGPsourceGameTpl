		...
		return Array(
			...
			'Game' => Array(
				...
				'url' => Array(
					...
					//отдает массив с картами - какие исследованы, какие нет и цены. для страницы магазин+исследования
					'cards/all' => array(
						'cache' => 5,
						'action' => 'cardsDataLoading',
						'handler' => Array('Game_Cards', 'app_cardsDataLoading')
					...
					'cards/my' => Array(
						'action' => 'myCardsDeka',
						'cache' => 5,
						'handler' => Array('Game_Cards', 'app_loadMyCards')					
					)					
